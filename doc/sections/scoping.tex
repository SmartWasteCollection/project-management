...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item La componente riesce a generare correttamente una missione ordinaria in seguito ad una notifica ricevuta da un cassonetto pieno.
        \item La componente riesce a generare correttamente missioni straordinarie con frequenza giornaliera.
    \end{enumerate}
    \item \textbf{Admin Dashboard}:
    \begin{enumerate}
