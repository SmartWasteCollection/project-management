...
In seguito all'analisi del dominio, è stato prodotto un \textit{Project Overview Statement} per ricevere l'approvazione da parte del \textit{senior management} a procedere con il progetto. Il \textit{POS} prodotto è qui riportato:
...
\possec{Criteri di Successo}{
    \begin{enumerate}
        \item I cassonetti dei rifiuti non raggiungono mai al 100\% di volume occupato.
        \item Non si ricevono più di 5 reclami al mese.
        \item Le prenotazioni di smaltimento di rifiuti straordinari avvengono al 95\% sulla \textbf{Citizen App}.
    \end{enumerate}
}
